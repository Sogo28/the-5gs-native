...
class DisplayRotationHelper(context: Context) : DisplayListener {
    ...
    public var viewportWidth = 0
    public var viewportHeight = 0
    ...
    fun onSurfaceChanged(width: Int, height: Int) {
        ...
        Log.i("DisplayRotationHelper", "Appel de session.setDisplayGeometry: viewportChanged=$viewportChanged, viewportWidth=$viewportWidth, viewportHeight=$viewportHeight")
    }
    ...
    fun updateSessionIfNeeded(session: Session) {
        if (viewportChanged) {
            ...
            Log.i("DisplayRotationHelper", "Appel de session.setDisplayGeometry: rotation=$displayRotation, viewportWidth=$viewportWidth, viewportHeight=$viewportHeight")
